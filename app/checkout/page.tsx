...
export default function CheckoutPage() {
  ...
  async function onSubmit(data: CheckoutSchema) {
    ...
    if (!data.customer_name || !data.customer_phone || !data.delivery_address) {
      toast.error("Please fill in all required fields (Name, Phone, Delivery Address).")
      setLoading(false)
      return
    }
    setLoading(true)
              ...
              <div className="lg:col-span-2 space-y-5">
                ...
                <div className="bg-white border border-border rounded-xl p-6">
                  ...
                  <div className="flex items-center gap-4 p-4 border-2 border-dashed border-border rounded-xl opacity-50 cursor-not-allowed">
                    ...
                    <span className="ml-auto text-2xs bg-gray-100 text-gray-500 px-2 py-1 rounded-full font-medium">Soon</span>
                  </div>
