...
export const metadata: Metadata = {
  // ── Basic
  title: {
    default:  'Niks Digital Connections – Electronics & Home Appliances | Nairobi',
  ...
  publisher: 'Niks Digital Connections',
  ...
  openGraph: {
    ...
    title:       'Niks Digital Connections – Smart Electronics & Home Appliances',
    description:
    ...
    images: [
      {
        ...
        width:  1200,
        height: 630,
        alt:    'Niks Digital Connections – Electronics Shop Nairobi',
      },
    ],
  },
  ...
  twitter: {
    ...
    title:       'Niks Digital Connections – Electronics & Appliances',
