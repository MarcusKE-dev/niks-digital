    ...
    <>
      ...
      <main>
        ...
        {/* ══════════════════════════════════════════════════
            HERO
        ══════════════════════════════════════════════════ */}
        <section className="bg-white section-padding" aria-label="Welcome to Niks Digital Connections">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <div className="relative rounded-xl overflow-hidden border border-border bg-surface aspect-[4/3]">
                <Image
                  ...
                  alt="Electronics and home appliances at Niks Digital Connections, Nairobi"
                  fill
